...
ggplot(data = rec_distrib, aes(x = x)) +
  stat_function(fun = dnorm, args = list(mean = S_1yo, sd = S_1yo_sd), color = "blue", size = 1) +
  labs(x = "logArea", y = "Density") +
  theme_bw()
